<template>
  <div class="app-container">
    ...
    <div class="filter-container" style="margin-bottom: 15px">
      <!-- 用户名输入 -->
      <el-input v-model="queryParam.username" v-permission="['admin']" placeholder="用户名" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <!-- 图书名输入 -->
      <el-input v-model="queryParam.bookname" placeholder="图书名" style="width: 200px; margin-left: 10px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <!-- 一些按钮 -->
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-button type="warning" size="small" @click="handleReturn(scope.row,scope.$index)">归还图书</el-button>
